...
[类](/classes) 是用于创建复杂对象的一个更高级的语法，我们稍后会讲到。
...
在我们学习了那些之后，我们将回到对象，在[ 原型，继承](/prototypes) 和  [类](/classes) 章节中深入介绍它们。

:::

## 任务

<https://zh.javascript.info/constructor-new#tasks>
