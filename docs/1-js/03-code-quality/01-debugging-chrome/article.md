...
- 在 Chrome 中打开 [示例页面](/html/debugging/index.html)。
...
我们来看看 [示例页面](/html/debugging/index.html) 发生了什么。在 `hello.js` 中，点击第 `4` 行。是的，就点击数字 `"4"` 上，不是点击代码。
