...
之后，在我们学习完 object 类型后，我们会在 [对象 — 原始值转换](/object-toprimitive) 一章中学习对象 — 原始值转换。
...
我们在本小节没有讲 object 类型的转换。在我们学习完更多关于 JavaScript 的基础知识后，我们会在专门介绍 object 的章节 [对象 — 原始值转换](/object-toprimitive) 中详细讲解 object 类型转换。